...
{
    public partial class frmReportePolizaPorCliente : System.Web.UI.Page
    {
        ...
        void contruirReporte()
        {
            ...
            else
            {
                ...
                var datosReporte = modeloBD.RetornaPolizaUsuario(this.txtPriApellido.Text, this.txtNombreCobertura.Text).ToList();
