<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PaginaMaestra.Master" AutoEventWireup="true" 
    CodeBehind="frmEliminarAdicciones.aspx.cs" Inherits="ProyectoNuevoFinal.Formularios.frmEliminarAdicciones" %>
                ...
                <div class="col-sm-12">
                    ...
                    <asp:Panel ID="PanelAlerta" runat="server" CssClass="col-md-12" Visible="false">
                        <div class="alert alert-danger alert-dismissable" role="alert">
                            <span class="glyphicon glyphicon-warning-sign"></span> <asp:Label 
                                ID="lblResultado" runat="server" Text=""></asp:Label>
                         </div>
                    </asp:Panel>
                        <center>
                    ...
                    <div class="form-horizontal">
                        <div class="col-md-12">
                            <asp:Button ID="btnEliminar" runat="server" class="btn btn-success 
                                btn-lg" Text="Eliminar" OnClick="btnGuardar_Click"   />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
