<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PaginaMaestra.Master" AutoEventWireup="true" 
    CodeBehind="frmReporteAdiccionesPorCliente.aspx.cs" Inherits="ProyectoNuevoFinal.Formularios.frmReporteAdiccionesPorCliente" %>
    ...
    <section class="adicciones-Lista">
        <div class="contenido-principal">
            ...
            <div class="grupo-principal">
                    ...
                    <asp:TextBox ID="txtDescCate" runat="server" ></asp:TextBox>
                &nbsp;&nbsp;
