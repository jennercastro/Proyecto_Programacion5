<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PaginaMaestra.Master" AutoEventWireup="true" 
    CodeBehind="frmRegistroUsuarioAdmin.aspx.cs" Inherits="ProyectoNuevoFinal.Formularios.frmRegistroUsuarioAdmin" %>
                    ...
                    <asp:Panel ID="PanelAlerta" runat="server" CssClass="col-md-12" Visible="false">
                        ...
                        <div class="col-sm-4 form-group">
                         ...
                         <div class="col-sm-4 form-group">
                          ...
                          <div class="col-sm-4 form-group">
                            ...
                            <label>Tipo Usuario</label><br />
                             <asp:DropDownList ID="DropListTipoUsuario" runat="server" ></asp:DropDownList>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <asp:RequiredFieldValidator ID="rfvTipoUsuario" runat="server" ControlToValidate="DropListTipoUsuario" ErrorMessage="Ingrese un tipo de usuario"></asp:RequiredFieldValidator>
                            <br />
                        </div>
                         ...
                         <div class="col-sm-4 form-group">
                            ...
                            <asp:TextBox placeholder="Alias de Usuario" ID="txtAliasUsuario" runat="server"></asp:TextBox>
                            &nbsp;&nbsp;
                            ...
                            <asp:TextBox placeholder="Contraseña" ID="txtPassUsuario" runat="server"></asp:TextBox>
                            &nbsp;&nbsp;
                            ...
                            <asp:TextBox placeholder="Direccion" ID="txtDireccion" runat="server"></asp:TextBox>
                            &nbsp;&nbsp;
